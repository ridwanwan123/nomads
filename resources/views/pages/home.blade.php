            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8 text-center">
                        <img src="frontend/images/partner@2x.png" alt="Logo Partners" srcset="" class="img-partner">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="section-popular-travel row justify-content-center">
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="frontend/images/avatar-1.png" alt="user" srcset="" class="mb-4 rounded-circle">
                                <h3 class="mb-4"> Angga Risky</h3>
                                <p class="testimonial">
                                    " It was glorious and i could not stop to say woho for every single moment Dankeeee "
                                </p>
                            </div>
                            <hr>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="frontend/images/avatar-2.png" alt="user" srcset="" class="mb-4 rounded-circle">
                                <h3 class="mb-4"> Rifdha Aditia</h3>
                                <p class="testimonial">
                                    " It was glorious and i could not stop to say woho for every single moment Dankeeee "
                                </p>
                            </div>
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4">
                        <div class="card card-testimonial text-center">
                            <div class="testimonial-content">
                                <img src="frontend/images/avatar-3.png" alt="user" srcset="" class="mb-4 rounded-circle">
                                <h3 class="mb-4"> Felysia Inez </h3>
                                <p class="testimonial">
                                    " It was glorious and i could not stop to say woho for every single moment Dankeeee "
                                </p>
                            </div>
